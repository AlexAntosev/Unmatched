...
public class CooperativeMatchHandler : BaseMatchHandler
{
    private readonly ICooperativeRatingCalculator _ratingCalculator;

    public CooperativeMatchHandler(IUnitOfWork unitOfWork, IGameModeValidatorFactory validatorFactory, ICooperativeRatingCalculator ratingCalculator)

...
public class HeroesDataInitializer : IDataInitializer<Hero>
{
    ...
    public IEnumerable<Hero> GetEntities()
    {
        ...
        return new List<Hero>
        {
            ...
            new() { Name = HeroNames.InvisibleMan, Hp = 15, DeckSize = 30 },
            new() { Name = HeroNames.SherlokHolmes, Hp = 16, DeckSize = 30, Sidekicks = new List<Sidekick> { watson } },
            new() { Name = HeroNames.LittleRed, Hp = 14, DeckSize = 30, Sidekicks = new List<Sidekick> { huntsman } },
            new() { Name = HeroNames.Beowulf, Hp = 17, DeckSize = 30, Sidekicks = new List<Sidekick> { wiglaf } },
            new() { Name = HeroNames.Elektra, Hp = 16, DeckSize = 40, Sidekicks = new List<Sidekick> { hand } },
            new() { Name = HeroNames.Daredevil, Hp = 17, DeckSize = 22 },
            new() { Name = HeroNames.Bullseye, Hp = 14, DeckSize = 30, IsRanged = true },
            new() { Name = HeroNames.Ghostrider, Hp = 17, DeckSize = 30 },

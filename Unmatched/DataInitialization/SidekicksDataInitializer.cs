        ...
        return new List<Sidekick>
            {
                new()
                    {
                        Name = SidekickNames.Merlin,
                        Hp = 7,
                        IsRanged = true
                    },
                new()
                    {
                        Name = SidekickNames.Harpies,
                        Hp = 1,
                        Count = 3
                    },
                new()
                    {
                        Name = SidekickNames.ThePorter,
                        Hp = 6
                    },
                new()
                    {
                        Name = SidekickNames.TheJabberwock,
                        Hp = 8
                    },
                new()
                    {
                        Name = SidekickNames.Outlaws,
                        Hp = 1,
                        Count = 4
                    },
                new()
                    {
                        Name = SidekickNames.TheJackalope,
                        Hp = 6
                    },
                new()
                    {
                        Name = SidekickNames.TheSisters,
                        Hp = 1,
                        Count = 3
                    },
                new()
                ...
                new()
                    {
                        Name = SidekickNames.Huntsman,
                        Hp = 9,
                        IsRanged = true
                    },
                new()
                    {
                        Name = SidekickNames.Wiglaf,
                        Hp = 9
                    },
                new()
                    {
                        Name = SidekickNames.TheHand,
                        Hp = 1,
                        Count = 4
                    },
                new()
                    {
                        Name = SidekickNames.MistyKnight,
                        Hp = 6,
                        IsRanged = true
                    },
                new()
                    {
                        Name = SidekickNames.Archers,
                        Hp = 2,
                        Count = 2,
                        IsRanged = true
                    },
                ...
                new()
                    {
                        Name = SidekickNames.DrMalcolm,
                        Hp = 7
                    },
                new()
                    {
                        Name = SidekickNames.IngenWorkers,
                        Hp = 1,
                        Count = 3,
                        IsRanged = true
                    }

...
public static class HeroNames
{
    ...
    public const string BloodyMary = "Bloody Mary";
    ...
    public const string LukeCage = "Luke Cage";
    ...
    public const string RobinHood = "Robin hood";

    public const string SherlokHolmes = "Sherlok Holmes";
